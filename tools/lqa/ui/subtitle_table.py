...
class SubtitleTable(QTableWidget):
    ...
    def setup_ui(self):
        ...
        self.verticalHeader().setDefaultSectionSize(22) # 极高密度
        
        # 设置列宽
        self.setColumnWidth(0, 40)   # ID
        self.setColumnWidth(1, 100)  # Start
        self.setColumnWidth(2, 100)  # End
        self.setColumnWidth(3, 300)  # Source
        self.setColumnWidth(4, 300)  # Target
        self.setColumnWidth(5, 50)   # Score
